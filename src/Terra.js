    ...
    try {
      ...
      this.socket = makeWASocket({
        ...
        auth: {
          ...
          printQRInTerminal: this.config.use_pairing ? false : true,
        ...
        browser: ["Linux", "Chrome", "135.0.7049.114"],
        // browser: Browsers.ubuntu("TerraBot"),
      ...
      this.socket.ev.on("connection.update", async (update) => {
        ...
        // Emit QR code event for web interfaces
          ...
          let code = await this.socket.requestPairingCode(this.config.botNumber);
